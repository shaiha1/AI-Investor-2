...
export default function PortfolioList({ holdings, liveData, loadingTickers, onRemove, onAddManual }) {
    ...
    <div className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden">
      ...
      <ul className="divide-y divide-border">
        {holdings.map((h) => {
          ...
          return (
            <li key={h.id} className="flex items-center gap-4 px-5 py-3.5 hover:bg-muted/40 transition-colors">
              {/* Ticker */}
